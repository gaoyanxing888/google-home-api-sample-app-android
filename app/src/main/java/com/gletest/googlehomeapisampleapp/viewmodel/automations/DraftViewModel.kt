...
package com.gletest.googlehomeapisampleapp.viewmodel.automations
...
class DraftViewModel(
  ...
  init {
    ...
    description =
      MutableStateFlow(presetDraft?.description ?: (candidateVM?.description ?: DRAFT_DESCRIPTION))
              ...
              when (starterTrait) {
                OnOff -> {
                  ...
                  when (starterOperation) {
                    ...
                    StarterViewModel.Operation.NOT_EQUALS ->
                      ...
                      MainActivity.showError(this, "Unexpected operation for OnOff")
                    }
                  }
                }
                ...
                LevelControl -> {
                  ...
                  when (starterOperation) {
                    ...
                    StarterViewModel.Operation.GREATER_THAN_OR_EQUALS ->
                      condition {
                        expression = levelExpression.currentLevel greaterThanOrEquals levelValue
                      }
                    ...
                    StarterViewModel.Operation.LESS_THAN_OR_EQUALS ->
                      condition {
                        expression = levelExpression.currentLevel lessThanOrEquals levelValue
                      }

                    else -> {
                      MainActivity.showError(this, "Unexpected operation for LevelControl")
                    }
                  }
                }
                ...
                BooleanState -> {
                  ...
                  when (starterOperation) {
                    StarterViewModel.Operation.EQUALS ->
                      condition {
                        expression = booleanStateExpression.stateValue equals booleanStateValue
                      }

                    StarterViewModel.Operation.NOT_EQUALS ->
                      condition {
                        expression = booleanStateExpression.stateValue notEquals booleanStateValue
                      }

                    else -> {
                      MainActivity.showError(this, "Unexpected operation for BooleanState")
                    }
                  }
                }

                OccupancySensing -> {
                  val occupancyValue: OccupancySensingTrait.OccupancyBitmap =
                    starterVM.valueOccupancy.value
                  ...
                  when (starterOperation) {
                    ...
                    StarterViewModel.Operation.NOT_EQUALS ->
                      condition {
                        expression = occupancyExpression.occupancy notEquals occupancyValue
                      }
                ...
                Thermostat -> {
                  val thermostatValue: ThermostatTrait.SystemModeEnum =
                    starterVM.valueThermostat.value
                  val thermostatExpression: TypedExpression<out Thermostat> =
                    starterExpression as TypedExpression<out Thermostat>
                  when (starterOperation) {
                    StarterViewModel.Operation.EQUALS ->
                      condition {
                        expression = thermostatExpression.systemMode equals thermostatValue
                      }

                    StarterViewModel.Operation.NOT_EQUALS ->
                      condition {
                        expression = thermostatExpression.systemMode notEquals thermostatValue
                      }

                    else -> {
                      MainActivity.showError(this, "Unexpected operation for Thermostat")
                    }
                  }
                }
                ...
                FanControl -> {
                  ...
                  when (starterOperation) {
                    ...
                    StarterViewModel.Operation.NOT_EQUALS ->
                      ...
                      MainActivity.showError(this, "Unexpected operation for FanControl")
                    }
                  }
                }

                else -> {
                  MainActivity.showError(this, "Unsupported starter for automation creation")
                }
              }
            }
          }
            ...
            if (isFanControlAction) {
              ...
              action(actionDeviceVM.device, actionDeviceVM.type.value.factory) {
                ...
                val actionCommand: Command = when (actionVM.action.value) {
                  ActionViewModel.Action.ON -> {
                    OnOff.on()
                  }

                  ActionViewModel.Action.OFF -> {
                    OnOff.off()
                  }
  ...
  companion object {
    private const val DRAFT_NAME: String = "New Automation"
    private const val DRAFT_DESCRIPTION: String = "New custom automation"
  }
}